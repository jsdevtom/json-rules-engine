...
describe('Engine: fact evaluation', () => {
    ...
    describe('path', () => {
        ...
        test(
            'does not emit when complex object paths fail the condition',
            async () => {
                let complexCondition = conditions()
                ;(complexCondition as any).any[0].path = '.address.occupantHistory[0].year'
    ...
    describe('synchronous functions', () => {
        test(
            'works with synchronous, non-promise evaluations that are truthy',
            async () => {
                setup()
                let eligibilityField = function () {
                    return 20
        ...
        test(
            'works with synchronous, non-promise evaluations that are falsey',
            async () => {
                setup()
                let eligibilityField = function () {
                    return 100
